...
1. Open `earth-engine/amd_detection_v2.4.0.js` in the GEE Code Editor, Run.
...
- Update `IronSulfate` (currently provisional 0.10) and the ferric/clay
  thresholds in `earth-engine/amd_detection_v2.4.0.js` `settings` to the derived
...
- **`amd_detection_v2.4.0.js`** — the detector, with the corrected index,
