...
4. **Circular validation.** `validation_results_2025-11_SUPERSEDED.md` control-lake 0% AMD is guaranteed by the water mask, not by the index — proves nothing. No confusion matrix/kappa/ground truth.
